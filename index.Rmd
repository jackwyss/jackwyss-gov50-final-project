...
There are 869 movies in this data set, which I formed by using inner_join to combine two datasets:

  A) a dataset containing information about movie series, including IMDb scores and the order of a film within a series
  B) a dataset containing information about individual movies, including box office revenue, budget, and IMDb score. Unknown budgets or revenues are represented with a       value of zero.
